...
对于2B的产品，销售将会是一个非常重要的环节，我们的目标市场是需要依赖AI技术来提高效率和创新广大的中小软件开发企业，以及任何需要减少测试成本，提高迭代速度的中小开发团队。

由于需要一定的开发时间，销售策略计划如下：

第一年：通过利用创始人的人脉和业内的小范围免费宣传推广，专注于直接销售。目标是获得100个感兴趣的用户的关注，大概10个正式客户项目，以验证产品。
第二年：产品得到成功的验证，并且经过几轮迭代推出了第一批可以商业化的能力，已经可以稳定为更多用户提供服务的时候，将会扩大推广力度，通过雇佣一名销售代表来建立专职销售团队。目标是实现100,000英镑的年收入，达到盈亏平衡。并将客户企业（团队）数量增加到100个，初步建立在自动化测试行业中的影响力。
第三年：在整个商业模式得到市场认可以后，再雇佣2-3名销售代表以进一步渗透市场。增大各种渠道的宣传力度，积极进入新的市场领域并将客户基础扩大到500个，实现500,000英镑的销售额。

## 11.2 Marketing Plan

<!-- 市场营销计划。不要求特别的想尽，但是要求与目标销售的产品和服务的方法匹配，以及预算要合理。 -->

作为数字化平台，Cyberbard的产品可以在任何地方轻松使用，我们的市场营销计划也会尽量使用更多的方式和渠道来进行宣传：
...
- 第二年：40,000英镑，包括持续的数字营销工作、额外的行业活动以及发布更多的营销文章，开始尝试针对中小软件开发团队的直接营销。
- 第三年：增加到100,000英镑来扩大营销力度，增加广告营销和直接营销的力度，目标是快速复制成功案例，扩大市场占有率。
...
初期品牌认知度和市场存在感有限。
团队规模小，可能限制快速扩展的能力；通过招聘计划来缓解这一点。
机会（Opportunities）：

各个行业对AI解决方案的需求不断增长。
与希望整合AI的成熟公司建立战略合作伙伴关系的潜力。
威胁（Threats）：

快速发展的技术环境可能会使当前的解决方案变得过时；通过持续的研发投资来缓解。
来自初创公司和大型科技公司的激烈竞争。 -->
...
- 根据客户反馈，不断改进产品实现稳定可靠的商业化能力
- 团队人数增加到4人
  - 增加销售人员1人，开始尝试商业宣传。
  - 技术团队增加全栈工程师工程师2人，负责优化平台产品细节，解决用户反馈的问题，快速迭代版本。
- 发展大约 800 个付费客户。
- 实现接近 £300,000 的收入。

## 第三年

- 实现稳定的产品市场契合度，通过各种手段，全面宣传，快速扩大用户量。
- 团队人数增加到10人
  - 销售团队扩展到3-4人，积极扩大市场。  
  - 算法团队增加LLM算法工程师2人，负责跟进最新LMM技术，不断优化模型能力。
  - 开发团队客户端工程师1人，负责扩展产品支持平台范围。
- 将业务扩展到 5000 个收费客户。
- 实现超过 £1,800,000的收入。
...
<!-- 创新性：AI解决方案提供了显著增强操作效率或客户体验的新功能。
可行性：产品具有清晰的路线图和在预算和时间范围内可实现的里程碑。
可扩展性：该解决方案可以轻松适应和扩展到新的市场和客户群，展现出强劲的增长潜力。 -->
...
- 研发费用：用于支付软件开发、人工智能算法的研究与优化、测试工具的设计与实现等相关费用。研发阶段将集中在第一个投资周期（即第一年），由于主要任务是新产品的研发，主要用来支付研发人员的工资，同时还需要支出相关工具软件的授权费用，AI算力的费用，还有训练模型过程中产生的费用，比方训练数据的收集授权费用等，预计此部分费用占总投资的60%。

- 市场推广和销售费用：包括推广人员的工资，用于产品上市前的市场调研、品牌推广、营销策略的制定与实施。预计占总投资的30%。

- 运营费用：包括的人员薪资、办公场所租赁、办公用品的购买，水电及其他日常运营开销。此部分费用预计占总投资的10%。
...
- 公司成立费用，相关办公设备的购买，财务费用，其他相关服务购买：£5,000
- 办公室费用：每人 £250 每个月的共享办公费用，每个月每人 £100 的日常办公杂项费用

产品研发相关费用

- 软件授权的费用，相关服务购买，相关硬件购买：£10,000
- 训练AI模型的相关成本（包括数据购买、数据整理、合规等产出的费用，算力成本）：£40,000

产品运行相关费用

- 第一年用户比较少，平台运行成本主要是支持用户使用的各种服务和算力的成本，大约：£500

市场营销相关费用

- 第一年主要是在行业内的论坛小范围推广和生产一些社交媒体的文章，预计费用：£1,000

人力资源成本

- 第一年主要是研发工作，也就是说大部分工作由创始人自己完成，按照年薪 £25,000 计算，用与创始人和家庭的日常生活开支。

# 19 PROFIT AND LOSS SUMMARY

<!-- 损益表。也就是未来3年预测的利润表。一般第一年是亏的，第二年会有盈利，第三年达标。 -->

第一年：由于在开发和营销上的高初始投资，净亏损。
第二年：随着客户基础的扩大和经常性收入的增加，实现盈亏平衡。
第三年：随着市场覆盖面的扩大和客户增长，实现盈利。

具体的损益表还在制作中，这个是大概的预测

![PLYear](pic/PLYear.png)
