...
const Cta = ({
	...
	return (
		...
		>
			...
			<h1 className="z-20 mx-auto mt-0 max-w-4xl font-normal tracking-tighter text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-center text-transparent bg-clip-text bg-gradient-to-tr from-zinc-400/50 to-white/60 via-white">
				Testing is no longer a burden<br />
				Cyberbard makes it<br />your ally
			</h1>
			<p className="z-20 text-center text-md md:text-lg">
				Let us keep you updated on the latest developments
			</p>
