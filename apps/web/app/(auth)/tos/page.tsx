	...
	return (
		<div className="flex flex-col items-center justify-center mt-8">
			<div className="max-w-3xl prose prose-invert">
				<Markdown>
					{`
            Terms of Service for Cyberbard

**Effective Date:** August 9, 2024

Welcome to Cyberbard! By using our app, you agree to the following terms and conditions. Please read them carefully.

### 1. Acceptance of Terms
By accessing or using the Cyberbard app, you agree to be bound by these Terms of Service and our Privacy Policy. If you do not agree with any part of these terms, you must not use the app.

### 2. Description of Service
Cyberbard allows users to save information from various sources on the internet, organize it, and interact with it using AI. The service includes features such as:
- Help users automatically test software, improve testing efficiency, and optimize software interaction processes
...
All content, trademarks, and data on the Cyberbard app are the property of Cyberbard or its licensors. You may not use any of this content without permission.
...
Cyberbard is provided "as is" without any warranties of any kind. We do not guarantee that the service will be uninterrupted or error-free. To the fullest extent permitted by law, Cyberbard will not be liable for any damages arising from the use of the app.
